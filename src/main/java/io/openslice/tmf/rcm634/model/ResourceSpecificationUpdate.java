...
public class ResourceSpecificationUpdate   {
  ...
  **/
  ...
  public ResourceSpecificationUpdate attachment(List<Attachment> attachment) {
    this.attachment = attachment;
    return this;
  }

  public ResourceSpecificationUpdate addAttachmentItem(Attachment attachmentItem) {
  ...
  **/
  ...
  public ResourceSpecificationUpdate relatedParty(List<RelatedPartyRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceSpecificationUpdate addRelatedPartyItem(RelatedPartyRef relatedPartyItem) {
