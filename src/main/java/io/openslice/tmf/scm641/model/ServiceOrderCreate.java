...
@Size(min=1) 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category, description, externalId, notificationContact, priority, requestedCompletionDate, requestedStartDate, note, orderItem, orderRelationship, relatedParty, baseType, schemaLocation, type);
  }
