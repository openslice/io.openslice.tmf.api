...
public class ServiceOrderUpdate   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category, description, expectedCompletionDate, notificationContact, requestedCompletionDate, requestedStartDate, startDate, note, orderRelationship, relatedParty, baseType, schemaLocation, type);
  }
