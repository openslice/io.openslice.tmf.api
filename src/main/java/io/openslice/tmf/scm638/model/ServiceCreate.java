...
import io.openslice.tmf.scm638.model.ServiceRelationship;
...
public class ServiceCreate   {
  ...
  **/
  ...
  public ServiceCreate place(List<Place> place) {
    this.place = place;
    return this;
  }

  public ServiceCreate addPlaceItem(Place placeItem) {
    if (this.place == null) {
  ...
  **/
  ...
  public ServiceCreate serviceOrder(List<ServiceOrderRef> serviceOrder) {
    this.serviceOrder = serviceOrder;
    return this;
  }

  public ServiceCreate addServiceOrderItem(ServiceOrderRef serviceOrderItem) {
  ...
  **/
   ...
   * @return state
  **/
  @ApiModelProperty(required = true, value = "The life cycle state of the service, such as: feasibilityChecked, designed, reserved, active, inactive, terminated")
  @NotNull
  ...
  **/
  ...
  public ServiceCreate supportingService(List<ServiceRef> supportingService) {
    this.supportingService = supportingService;
    return this;
  }

  public ServiceCreate addSupportingServiceItem(ServiceRef supportingServiceItem) {
