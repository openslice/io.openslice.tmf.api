...
import io.openslice.tmf.scm620.model.ProductSpecificationCharacteristicRelationship;
import io.openslice.tmf.scm620.model.ProductSpecificationCharacteristicValue;
...
public class ProductSpecificationCharacteristic   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configurable, description, extensible, isUnique, maxCardinality, minCardinality, name, regex, valueType, productSpecCharRelationship, productSpecCharacteristicValue, validFor, baseType, schemaLocation, type);
  }
