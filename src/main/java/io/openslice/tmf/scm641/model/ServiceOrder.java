...
import io.openslice.tmf.scm641.model.Note;
import io.openslice.tmf.scm641.model.RelatedParty;
import io.openslice.tmf.scm641.model.ServiceOrderItem;
import io.openslice.tmf.scm641.model.ServiceOrderRelationship;
import io.openslice.tmf.scm641.model.ServiceOrderStateType;
...
@Size(min=1) 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, category, completionDate, description, expectedCompletionDate, externalId, notificationContact, orderDate, priority, requestedCompletionDate, requestedStartDate, startDate, note, orderItem, orderRelationship, relatedParty, state, baseType, schemaLocation, type);
  }
