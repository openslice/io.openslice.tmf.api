...
public interface PushApi {
    ...
    @ApiOperation(value = "Creates a 'Push' action and modifies a Pool", nickname = "createPush", notes = "This operation runs TASK, which adds the capacity of the new resource to the resource pool.", response = ResourcePool.class, tags={ "push", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<ResourcePool> createPush(@ApiParam(value = "The Push to be performed" ,required=true )  @Valid @RequestBody PushCreate body
) {
