...
public class UserInfoType   extends BaseRootNamedEntity {
  ...
  @Valid
  private List<IdentificationType> legalId = null;

  @JsonProperty("userAssets")
  @Valid
  private List<UserAssetType> userAssets = null;
  ...
  **/
  ...
  /**
   * End-User's preferred e-mail address. Its value MUST conform to the [RFC5322] addr-spec syntax
   * @return email
  **/
  ...
  /**
   * End-User's preferred telephone number. [E.164] is RECOMMENDED as the format of this Claim, for example, +1 (425) 555-1212 or +56 82) 687 2400. If the phone number contains an extension, it is RECOMMENDED that the extension be represented using the [RFC3966] extension syntax, for example, +1 (604) 555-1234;ext=5678
   * @return phoneNumber
  **/
  ...
  **/
  ...
  public UserInfoType legalId(List<IdentificationType> legalId) {
  ...
  **/
  ...
  public List<IdentificationType> getLegalId() {
    return legalId;
  }

  public void setLegalId(List<IdentificationType> legalId) {
    this.legalId = legalId;
  }

  public UserInfoType userAssets(List<UserAssetType> userAssets) {
  ...
  **/
  ...
  public List<UserAssetType> getUserAssets() {
    return userAssets;
  }

  public void setUserAssets(List<UserAssetType> userAssets) {
    this.userAssets = userAssets;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sub, userInfoType.sub) &&
        Objects.equals(this.name, userInfoType.name) &&
        ...
        Objects.equals(this.type, userInfoType.type) &&
        Objects.equals(this.baseType, userInfoType.baseType) &&
