...
public class ServiceTest   {
  ...
  public ServiceTest id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ServiceTest characteristic(List<Characteristic> characteristic) {
  ...
  **/
  ...
  public ServiceTest relatedParty(List<RelatedParty> relatedParty) {
  ...
  **/
  ...
  public ServiceTest testMeasure(List<TestMeasure> testMeasure) {
  ...
  **/
  ...
  public ServiceTest _atBaseType(String _atBaseType) {
  ...
  **/
  ...
  public ServiceTest _atSchemaLocation(String _atSchemaLocation) {
  ...
  **/
  ...
  public ServiceTest _atType(String _atType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, serviceTest.id) &&
        Objects.equals(this.href, serviceTest.href) &&
        Objects.equals(this.description, serviceTest.description) &&
        Objects.equals(this.endDateTime, serviceTest.endDateTime) &&
        Objects.equals(this.mode, serviceTest.mode) &&
        Objects.equals(this.name, serviceTest.name) &&
        ...
        Objects.equals(this._atBaseType, serviceTest._atBaseType) &&
        Objects.equals(this._atSchemaLocation, serviceTest._atSchemaLocation) &&
        Objects.equals(this._atType, serviceTest._atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, description, endDateTime, mode, name, startDateTime, state, characteristic, relatedParty, relatedService, testMeasure, testSpecification, validFor, _atBaseType, _atSchemaLocation, _atType);
  }
