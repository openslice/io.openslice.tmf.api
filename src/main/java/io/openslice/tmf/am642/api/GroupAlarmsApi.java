...
public interface GroupAlarmsApi {
    ...
    default ResponseEntity<Alarm> groupAlarmsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Alarm body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default GroupAlarmsApi interface so no example is generated");
        }
