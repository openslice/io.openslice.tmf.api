...
public class LogicalResourceSpecUpdate {
	...
	public LogicalResourceSpecUpdate resourceSpecCharacteristic(
			List<ResourceSpecCharacteristic> resourceSpecCharacteristic) {
		this.resourceSpecCharacteristic = resourceSpecCharacteristic;
		return this;
	}

	public LogicalResourceSpecUpdate addResourceSpecCharacteristicItem(
	...
	public LogicalResourceSpecUpdate addResourceSpecRelationshipItem(
